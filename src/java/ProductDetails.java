            ...
            try {
                ...
                while(rs.next()){
                    ...
                    if (loopCheck == 0) {
                        ...
                        Set<String> viewerSet = new HashSet<String>();
                        int currentViewers;
                        if(servletContext.getAttribute(pid)==null) {
                            viewerSet.add(seshID);
                            servletContext.setAttribute(pid, viewerSet);
                            currentViewers = viewerSet.size();
                       }else{
                            viewerSet = (Set<String>) servletContext.getAttribute(pid);
                            viewerSet.add(seshID);
                            currentViewers = (int) viewerSet.size();
                            servletContext.setAttribute(pid, viewerSet);
                       }
                        ...
                        out.println("<h1>" + currentViewers+" other people looking at this fish.</h1>");
